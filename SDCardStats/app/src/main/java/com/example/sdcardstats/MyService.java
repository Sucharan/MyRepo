...
public class MyService extends Service {
    ...
    Thread thread = new Thread() {
        ...
        public void run() {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                Intent intent = new Intent(MainActivity.CUSTOM_ACTION);
                int size = 0;
                ...
                ArrayList<FileStats> tempList = new ArrayList<>();
                if(files.size()>10){
                ...
                Toast.makeText(getApplicationContext(), "Media is not avilable", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private Comparator<FileStats> fileSizeComparator = new Comparator<FileStats>() {
        @Override
        public int compare(FileStats lhs, FileStats rhs) {
    ...
    private ArrayList<FileStats> files;
